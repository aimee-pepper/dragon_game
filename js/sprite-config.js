...
export const ANCHORS = {
  ...
  'leg_bg_f:p1:standard:6l':               { x: 848, y: 1280 },
  ...
  'leg_bg_o:p1:standard:6l':               { x: 839, y: 1323 },
  ...
  'tail_heavy_l_f:bulky':                  { x: 1800, y: 1145 },
  'tail_heavy_l_f:sinuous':                { x: 1797, y: 1188 },
  'tail_heavy_l_f:standard':               { x: 1717, y: 1212 },
  'tail_heavy_l_o:bulky':                  { x: 1791, y: 1139 },
  'tail_heavy_l_o:sinuous':                { x: 1788, y: 1182 },
  'tail_heavy_l_o:standard':               { x: 1708, y: 1206 },
  'tail_heavy_m_f:bulky':                  { x: 1745, y: 1071 },
  'tail_heavy_m_f:sinuous':                { x: 1785, y: 1145 },
  'tail_heavy_m_f:standard':               { x: 1681, y: 1182 },
  'tail_heavy_m_o:bulky':                  { x: 1748, y: 1062 },
  'tail_heavy_m_o:sinuous':                { x: 1788, y: 1136 },
  'tail_heavy_m_o:standard':               { x: 1684, y: 1173 },
  'tail_heavy_s_f:bulky':                  { x: 1806, y: 1007 },
  'tail_heavy_s_f:sinuous':                { x: 1824, y: 1062 },
  'tail_heavy_s_f:standard':               { x: 1791, y: 1083 },
  'tail_heavy_s_o:bulky':                  { x: 1837, y: 1001 },
  'tail_heavy_s_o:sinuous':                { x: 1855, y: 1056 },
  'tail_heavy_s_o:standard':               { x: 1822, y: 1077 },
  'tail_normal_l_f:bulky':                 { x: 1158, y: 1111 },
  'tail_normal_l_f:sinuous':               { x: 1237, y: 1203 },
  'tail_normal_l_f:standard':              { x: 1170, y: 1249 },
  'tail_normal_l_o:bulky':                 { x: 968, y: 1102 },
  'tail_normal_l_o:sinuous':               { x: 1047, y: 1194 },
  'tail_normal_l_o:standard':              { x: 980, y: 1240 },
  'tail_normal_m_f:bulky':                 { x: 1760, y: 1135 },
  'tail_normal_m_f:sinuous':               { x: 1840, y: 1197 },
  'tail_normal_m_f:standard':              { x: 1767, y: 1212 },
  'tail_normal_m_o:bulky':                 { x: 1742, y: 1126 },
  'tail_normal_m_o:sinuous':               { x: 1822, y: 1188 },
  'tail_normal_m_o:standard':              { x: 1749, y: 1203 },
  'tail_normal_s_f:bulky':                 { x: 1788, y: 1142 },
  'tail_normal_s_f:sinuous':               { x: 1813, y: 1197 },
  'tail_normal_s_f:standard':              { x: 1755, y: 1215 },
  'tail_normal_s_o:bulky':                 { x: 1806, y: 1136 },
  'tail_normal_s_o:sinuous':               { x: 1831, y: 1191 },
  'tail_normal_s_o:standard':              { x: 1773, y: 1209 },
  'tail_whip_l_f:bulky':                   { x: 1152, y: 1127 },
  'tail_whip_l_f:sinuous':                 { x: 1201, y: 1203 },
  'tail_whip_l_f:standard':                { x: 1128, y: 1228 },
  'tail_whip_l_o:bulky':                   { x: 1118, y: 1124 },
  'tail_whip_l_o:sinuous':                 { x: 1167, y: 1200 },
  'tail_whip_l_o:standard':                { x: 1094, y: 1225 },
  'tail_whip_m_f:bulky':                   { x: 1807, y: 1176 },
  'tail_whip_m_f:sinuous':                 { x: 1850, y: 1218 },
  'tail_whip_m_f:standard':                { x: 1780, y: 1231 },
  'tail_whip_m_o:bulky':                   { x: 1831, y: 1170 },
  'tail_whip_m_o:sinuous':                 { x: 1874, y: 1212 },
  'tail_whip_m_o:standard':                { x: 1804, y: 1225 },
  'tail_whip_s_f:bulky':                   { x: 1800, y: 1124 },
  'tail_whip_s_f:sinuous':                 { x: 1865, y: 1185 },
  'tail_whip_s_f:standard':                { x: 1782, y: 1212 },
  'tail_whip_s_o:bulky':                   { x: 1791, y: 1121 },
  'tail_whip_s_o:sinuous':                 { x: 1856, y: 1182 },
  'tail_whip_s_o:standard':                { x: 1773, y: 1209 },

  'wing_bg_inner_f:p1:bulky:2w':           { x: 1226, y: 399, rot: -13 },
  'wing_bg_inner_f:p1:bulky:4w':           { x: 1020, y: 453, rot: -21 },
  'wing_bg_inner_f:p1:bulky:6w':           { x: 732, y: 591, rot: -39 },
  ...
  'wing_bg_inner_f:p1:standard:6w':        { x: 773, y: 683, rot: -40 },
  'wing_bg_inner_f:p2:bulky:4w':           { x: 1659, y: 436, rot: -1 },
  'wing_bg_inner_f:p2:bulky:6w':           { x: 1782, y: 425, rot: 11 },
  'wing_bg_inner_f:p2:sinuous:4w':         { x: 1186, y: 551, rot: -10 },
  'wing_bg_inner_f:p2:sinuous:6w':         { x: 1338, y: 492, rot: -5 },
  'wing_bg_inner_f:p2:standard:4w':        { x: 931, y: 551, rot: -25 },
  'wing_bg_inner_f:p2:standard:6w':        { x: 1308, y: 465, rot: -7 },
  'wing_bg_inner_f:p3:bulky:6w':           { x: 1276, y: 382, rot: -9 },
  'wing_bg_inner_f:p3:sinuous:6w':         { x: 1876, y: 535, rot: 10 },
  'wing_bg_inner_f:p3:standard:6w':        { x: 1696, y: 517, rot: 4 },
  'wing_bg_inner_o:p1:bulky:2w':           { x: 1106, y: 360, rot: -13 },
  'wing_bg_inner_o:p1:bulky:4w':           { x: 900, y: 414, rot: -21 },
  'wing_bg_inner_o:p1:bulky:6w':           { x: 612, y: 552, rot: -39 },
  ...
  'wing_bg_inner_o:p1:standard:6w':        { x: 653, y: 644, rot: -40 },
  'wing_bg_inner_o:p2:bulky:4w':           { x: 1539, y: 397, rot: -1 },
  'wing_bg_inner_o:p2:bulky:6w':           { x: 1662, y: 386, rot: 11 },
  'wing_bg_inner_o:p2:sinuous:4w':         { x: 1066, y: 512, rot: -10 },
  'wing_bg_inner_o:p2:sinuous:6w':         { x: 1218, y: 453, rot: -5 },
  'wing_bg_inner_o:p2:standard:4w':        { x: 811, y: 512, rot: -25 },
  'wing_bg_inner_o:p2:standard:6w':        { x: 1188, y: 426, rot: -7 },
  'wing_bg_inner_o:p3:bulky:6w':           { x: 1156, y: 343, rot: -9 },
  'wing_bg_inner_o:p3:sinuous:6w':         { x: 1756, y: 496, rot: 10 },
  'wing_bg_inner_o:p3:standard:6w':        { x: 1576, y: 478, rot: 4 },
  'wing_bg_outer_f:p1:bulky:2w':           { x: 1112, y: 363, rot: -13 },
  'wing_bg_outer_f:p1:bulky:4w':           { x: 906, y: 417, rot: -21 },
  'wing_bg_outer_f:p1:bulky:6w':           { x: 618, y: 555, rot: -39 },
  ...
  'wing_bg_outer_f:p1:standard:6w':        { x: 659, y: 647, rot: -40 },
  'wing_bg_outer_f:p2:bulky:4w':           { x: 1545, y: 400, rot: -1 },
  'wing_bg_outer_f:p2:bulky:6w':           { x: 1668, y: 389, rot: 11 },
  'wing_bg_outer_f:p2:sinuous:4w':         { x: 1072, y: 515, rot: -10 },
  'wing_bg_outer_f:p2:sinuous:6w':         { x: 1224, y: 456, rot: -5 },
  'wing_bg_outer_f:p2:standard:4w':        { x: 817, y: 515, rot: -25 },
  'wing_bg_outer_f:p2:standard:6w':        { x: 1194, y: 429, rot: -7 },
  'wing_bg_outer_f:p3:bulky:6w':           { x: 1162, y: 346, rot: -9 },
  'wing_bg_outer_f:p3:sinuous:6w':         { x: 1762, y: 499, rot: 10 },
  'wing_bg_outer_f:p3:standard:6w':        { x: 1582, y: 481, rot: 4 },
  'wing_bg_outer_o:p1:bulky:2w':           { x: 1106, y: 360, rot: -13 },
  'wing_bg_outer_o:p1:bulky:4w':           { x: 900, y: 414, rot: -21 },
  'wing_bg_outer_o:p1:bulky:6w':           { x: 612, y: 552, rot: -39 },
  ...
  'wing_bg_outer_o:p1:standard:6w':        { x: 653, y: 644, rot: -40 },
  'wing_bg_outer_o:p2:bulky:4w':           { x: 1539, y: 397, rot: -1 },
  'wing_bg_outer_o:p2:bulky:6w':           { x: 1662, y: 386, rot: 11 },
  'wing_bg_outer_o:p2:sinuous:4w':         { x: 1066, y: 512, rot: -10 },
  'wing_bg_outer_o:p2:sinuous:6w':         { x: 1218, y: 453, rot: -5 },
  'wing_bg_outer_o:p2:standard:4w':        { x: 811, y: 512, rot: -25 },
  'wing_bg_outer_o:p2:standard:6w':        { x: 1188, y: 426, rot: -7 },
  'wing_bg_outer_o:p3:bulky:6w':           { x: 1156, y: 343, rot: -9 },
  'wing_bg_outer_o:p3:sinuous:6w':         { x: 1756, y: 496, rot: 10 },
  'wing_bg_outer_o:p3:standard:6w':        { x: 1576, y: 478, rot: 4 },
  ...
  'wing_fg_inner_f:p1:bulky:2w':           { x: 1608, y: 414, rot: 8 },
  'wing_fg_inner_f:p1:bulky:4w':           { x: 1241, y: 424, rot: -12 },
  'wing_fg_inner_f:p1:bulky:6w':           { x: 2121, y: 529, rot: 34 },
  'wing_fg_inner_f:p1:sinuous:2w':         { x: 1524, y: 551 },
  'wing_fg_inner_f:p1:sinuous:4w':         { x: 1868, y: 578, rot: 4 },
  'wing_fg_inner_f:p1:sinuous:6w':         { x: 960, y: 700, rot: -29 },
  'wing_fg_inner_f:p1:standard:2w':        { x: 1391, y: 502 },
  'wing_fg_inner_f:p1:standard:4w':        { x: 1804, y: 562, rot: 12 },
  'wing_fg_inner_f:p1:standard:6w':        { x: 936, y: 669, rot: -31 },
  'wing_fg_inner_f:p2:bulky:4w':           { x: 1835, y: 494, rot: 6 },
  'wing_fg_inner_f:p2:bulky:6w':           { x: 1473, y: 441 },
  'wing_fg_inner_f:p2:sinuous:4w':         { x: 1336, y: 546, rot: -6 },
  'wing_fg_inner_f:p2:sinuous:6w':         { x: 2072, y: 586, rot: 21 },
  'wing_fg_inner_f:p2:standard:4w':        { x: 1332, y: 500 },
  'wing_fg_inner_f:p2:standard:6w':        { x: 1473, y: 503 },
  'wing_fg_inner_f:p3:bulky:6w':           { x: 981, y: 497, rot: -24 },
  'wing_fg_inner_f:p3:sinuous:6w':         { x: 1499, y: 555 },
  'wing_fg_inner_f:p3:standard:6w':        { x: 1987, y: 586, rot: 21 },
  'wing_fg_inner_o:p1:bulky:2w':           { x: 1694, y: 414, rot: 8 },
  'wing_fg_inner_o:p1:bulky:4w':           { x: 1327, y: 424, rot: -12 },
  'wing_fg_inner_o:p1:bulky:6w':           { x: 2207, y: 529, rot: 34 },
  'wing_fg_inner_o:p1:sinuous:2w':         { x: 1610, y: 551 },
  'wing_fg_inner_o:p1:sinuous:4w':         { x: 1954, y: 578, rot: 4 },
  'wing_fg_inner_o:p1:sinuous:6w':         { x: 1046, y: 700, rot: -29 },
  'wing_fg_inner_o:p1:standard:2w':        { x: 1477, y: 502 },
  'wing_fg_inner_o:p1:standard:4w':        { x: 1890, y: 562, rot: 12 },
  'wing_fg_inner_o:p1:standard:6w':        { x: 1022, y: 669, rot: -31 },
  'wing_fg_inner_o:p2:bulky:4w':           { x: 1921, y: 494, rot: 6 },
  'wing_fg_inner_o:p2:bulky:6w':           { x: 1559, y: 441 },
  'wing_fg_inner_o:p2:sinuous:4w':         { x: 1422, y: 546, rot: -6 },
  'wing_fg_inner_o:p2:sinuous:6w':         { x: 2158, y: 586, rot: 21 },
  'wing_fg_inner_o:p2:standard:4w':        { x: 1418, y: 500 },
  'wing_fg_inner_o:p2:standard:6w':        { x: 1559, y: 503 },
  'wing_fg_inner_o:p3:bulky:6w':           { x: 1067, y: 497, rot: -24 },
  'wing_fg_inner_o:p3:sinuous:6w':         { x: 1585, y: 555 },
  'wing_fg_inner_o:p3:standard:6w':        { x: 2073, y: 586, rot: 21 },
  'wing_fg_outer_f:p1:bulky:2w':           { x: 1470, y: 380, rot: 8 },
  'wing_fg_outer_f:p1:bulky:4w':           { x: 1103, y: 390, rot: -12 },
  'wing_fg_outer_f:p1:bulky:6w':           { x: 1983, y: 495, rot: 34 },
  'wing_fg_outer_f:p1:sinuous:2w':         { x: 1386, y: 517 },
  'wing_fg_outer_f:p1:sinuous:4w':         { x: 1730, y: 544, rot: 4 },
  'wing_fg_outer_f:p1:sinuous:6w':         { x: 822, y: 666, rot: -29 },
  'wing_fg_outer_f:p1:standard:2w':        { x: 1253, y: 468 },
  'wing_fg_outer_f:p1:standard:4w':        { x: 1666, y: 528, rot: 12 },
  'wing_fg_outer_f:p1:standard:6w':        { x: 798, y: 635, rot: -31 },
  'wing_fg_outer_f:p2:bulky:4w':           { x: 1697, y: 460, rot: 6 },
  'wing_fg_outer_f:p2:bulky:6w':           { x: 1335, y: 407 },
  'wing_fg_outer_f:p2:sinuous:4w':         { x: 1198, y: 512, rot: -6 },
  'wing_fg_outer_f:p2:sinuous:6w':         { x: 1934, y: 552, rot: 21 },
  'wing_fg_outer_f:p2:standard:4w':        { x: 1194, y: 466 },
  'wing_fg_outer_f:p2:standard:6w':        { x: 1335, y: 469 },
  'wing_fg_outer_f:p3:bulky:6w':           { x: 843, y: 463, rot: -24 },
  'wing_fg_outer_f:p3:sinuous:6w':         { x: 1361, y: 521 },
  'wing_fg_outer_f:p3:standard:6w':        { x: 1849, y: 552, rot: 21 },
  'wing_fg_outer_o:p1:bulky:2w':           { x: 1470, y: 380, rot: 8 },
  'wing_fg_outer_o:p1:bulky:4w':           { x: 1103, y: 390, rot: -12 },
  'wing_fg_outer_o:p1:bulky:6w':           { x: 1983, y: 495, rot: 34 },
  'wing_fg_outer_o:p1:sinuous:2w':         { x: 1386, y: 517 },
  'wing_fg_outer_o:p1:sinuous:4w':         { x: 1730, y: 544, rot: 4 },
  'wing_fg_outer_o:p1:sinuous:6w':         { x: 822, y: 666, rot: -29 },
  'wing_fg_outer_o:p1:standard:2w':        { x: 1253, y: 468 },
  'wing_fg_outer_o:p1:standard:4w':        { x: 1666, y: 528, rot: 12 },
  'wing_fg_outer_o:p1:standard:6w':        { x: 798, y: 635, rot: -31 },
  'wing_fg_outer_o:p2:bulky:4w':           { x: 1697, y: 460, rot: 6 },
  'wing_fg_outer_o:p2:bulky:6w':           { x: 1335, y: 407 },
  'wing_fg_outer_o:p2:sinuous:4w':         { x: 1198, y: 512, rot: -6 },
  'wing_fg_outer_o:p2:sinuous:6w':         { x: 1934, y: 552, rot: 21 },
  'wing_fg_outer_o:p2:standard:4w':        { x: 1194, y: 466 },
  'wing_fg_outer_o:p2:standard:6w':        { x: 1335, y: 469 },
  'wing_fg_outer_o:p3:bulky:6w':           { x: 843, y: 463, rot: -24 },
  'wing_fg_outer_o:p3:sinuous:6w':         { x: 1361, y: 521 },
  'wing_fg_outer_o:p3:standard:6w':        { x: 1849, y: 552, rot: 21 },
