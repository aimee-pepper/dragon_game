...
export const SKILL_DEFS = {
  ...
  'allele-peek-1': {
    ...
    effect: { type: 'reveal', mode: 'peek', traitCount: 1 },
    requires: null,
  },
  'allele-peek-2': {
    ...
    effect: { type: 'reveal', mode: 'peek', traitCount: 3 },
  ...
  'allele-peek-3': {
    ...
    effect: { type: 'reveal', mode: 'peek', traitCount: 6 },
  ...
  'egg-candling-1': {
    ...
    effect: { type: 'egg-reveal', mode: 'peek', traitCount: 1 },
    requires: { skill: 'allele-peek-3' },
  },
  'egg-candling-2': {
    ...
    effect: { type: 'egg-reveal', mode: 'peek', traitCount: 3 },
  ...
  'egg-candling-3': {
    ...
    effect: { type: 'egg-reveal', mode: 'peek', traitCount: 6 },
  ...
  'egg-pricing-1': {
    ...
    name: 'Egg Pricing I', desc: 'Egg sale price → 6 gold',
    effect: { type: 'egg-pricing', percent: 0.10 },
    requires: null,
  },
  'egg-pricing-2': {
    branch: 'handler', line: 'egg-sales', tier: 2,
    name: 'Egg Pricing II', desc: 'Egg sale price → 6 gold',
    effect: { type: 'egg-pricing', percent: 0.20 },
    requires: { skill: 'egg-pricing-1' },
  },
  'egg-pricing-3': {
    branch: 'handler', line: 'egg-sales', tier: 3,
    name: 'Egg Pricing III', desc: 'Egg sale price → 7 gold',
    effect: { type: 'egg-pricing', percent: 0.30 },
    requires: { skill: 'egg-pricing-2' },
  },
  'egg-pricing-4': {
    branch: 'handler', line: 'egg-sales', tier: 4,
    name: 'Egg Pricing IV', desc: 'Egg sale price → 7 gold',
    effect: { type: 'egg-pricing', percent: 0.40 },
    requires: { skill: 'egg-pricing-3' },
  },
  'egg-pricing-5': {
    branch: 'handler', line: 'egg-sales', tier: 5,
    name: 'Egg Pricing V', desc: 'Egg sale price → 8 gold',
    effect: { type: 'egg-pricing', percent: 0.50 },
    requires: { skill: 'egg-pricing-4' },
  },
  'egg-pricing-6': {
    branch: 'handler', line: 'egg-sales', tier: 6,
    name: 'Egg Pricing VI', desc: 'Egg sale price → 8 gold',
    effect: { type: 'egg-pricing', percent: 0.65 },
    requires: { skill: 'egg-pricing-5' },
  },
  'egg-pricing-7': {
    branch: 'handler', line: 'egg-sales', tier: 7,
    name: 'Egg Pricing VII', desc: 'Egg sale price → 9 gold',
    effect: { type: 'egg-pricing', percent: 0.80 },
    requires: { skill: 'egg-pricing-6' },
  },
  'egg-pricing-8': {
    branch: 'handler', line: 'egg-sales', tier: 8,
    name: 'Egg Pricing VIII', desc: 'Egg sale price → 10 gold',
    effect: { type: 'egg-pricing', percent: 1.00 },
